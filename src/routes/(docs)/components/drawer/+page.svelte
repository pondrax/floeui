...
<div class="alert text-sm mt-4">
  ...
  >
  <div>
    Drawer sidebar is hidden by default. You can make it visible on larger
    screens using <code>lg:drawer-open</code> class (or using other responsive
    prefixes: <code>sm</code>, <code>md</code>, <code>lg</code>,
    <code>xl</code>)
  </div>
</div>
...
<div class="alert text-sm mt-4">
  ...
  >
  <div>
    You can check/uncheck the checkbox using JavaScript or by clicking the <code
      >&lt;label&gt;</code
...
<Preview
  title="Drawer"
  code={`<div class="drawer h-56 rounded overflow-hidden">
...
<Preview
  title="Responsive"
  code={`<div class="drawer lg-drawer-open">
...
<Preview
  ...
  code={`<div class="drawer drawer-end">
