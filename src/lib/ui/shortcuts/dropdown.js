const dropdown = [
	...
	[
		'dropdown-top',
		['last-children-( origin-bottom bottom-full top-auto )'].join(' '),
		{ layer: 'components dropdown' }
	],
	[
		'dropdown-left',
		['last-children-( origin-bottom top-0 right-full bottom-auto )'].join(' '),
		{ layer: 'components dropdown' }
	],
	[
		'dropdown-right',
		['last-children-( origin-bottom top-0 left-full bottom-auto )'].join(' '),
		{ layer: 'components dropdown' }
	],
	[
		'dropdown-end',
		['last-children-( origin-bottom right-0 )'].join(' '),
		{ layer: 'components dropdown' }
	]
];
